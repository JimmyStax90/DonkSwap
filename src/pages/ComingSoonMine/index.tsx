      ...
      <div className="stake-stats">
        ...
        <div className="stake-stat-second-level">
          ...
          <div className="balance-and-display-container">
              ...
              <div className="stake-stat-display">
                <p className="txt-amount">{totalStakedBalance ? ethers.utils.formatEther(totalStakedBalance) : 0}</p>
              </div>
            </div>
            ...
            <div className="balance-and-display-container">
              ...
              <div className="stake-stat-display">
                <p className="txt-amount">{totalRewards ? ethers.utils.formatUnits(totalRewards,9).slice(0, ethers.utils.formatUnits(totalRewards,9).indexOf(".")+3) : 0}</p>
              </div>
            </div>
          </div>
        </div>
