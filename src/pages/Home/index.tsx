                ...
                <div className="left-of-first-box">
                    ...
                    <div className="quickgo-button-container">
                        <div className="quickgo-button-hugger">
                            ...
                            <a href="https://whitepaper.donkswap.com/">
                    ...
                    <div className="tokenomics-container">
                        ...
                        <div className="tokenomics-content-container">
                            <p className="tokenomics-list-heading-container">
                                There is a 0% fee on every transaction and transfer.
                            </p>
                            <div className="tokenomics-list-container">
                                <h3 className="tokenomics-bullet-title"> We decided to turn off all fees for $DST!</h3>
                                This provides our community with added incentive to enjoy our casino when it launches.
                                <br></br>
                                <br></br>
                                <h3 className="tokenomics-bullet-title">  There will be a 3% casino transaction fee</h3>
                                This transaction fee will help sustain the growth of Donkey King Casino and allow us to expand further.
                                <br></br>
                                <br></br>
                                <h3 className="tokenomics-bullet-title"></h3>
                                <b></b>
                            </div>
                        </div>
                    </div>
